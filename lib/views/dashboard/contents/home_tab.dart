                            ...
                            Row(
                              children: [
                                Icon(
                                  ...
                                  size: 12,
                                  color:
                                      _isAvailabel ? Colors.green : Colors.red,
                                ),
                                SizedBox(
                                  width: 12,
                                ),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      _summary['completed_rides'].toString(),
                                      style: TextStyle(
                                        fontSize: 24,
                                        color: const Color(0xffffffff),
                                        fontWeight: FontWeight.w600,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      _summary['cancel_rides'].toString(),
                                      style: TextStyle(
                                        fontSize: 24,
                                        color: const Color(0xffffffff),
                                        fontWeight: FontWeight.w600,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      _summary['montly_gains'].toString(),
