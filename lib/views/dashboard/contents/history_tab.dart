            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(upComingTripModel['service_type_id'] == null
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  upComingTripModel['user_rated'].toString(),
                                  style: TextStyle(
                                    fontFamily: 'Metropolis',
                                    fontSize: 11,
                                ...
                                Expanded(
                                  child: Text(
                                    '${upComingTripModel['service_type_id'] == null ? "" : isOngoing ? 'Rs.' + ((double.parse(upComingTripModel['service_type_price'])).round() + int.parse(upComingTripModel['service_type_fixed'])).toString() : 'Rs.' + upComingTripModel['payment_provider_pay']}',
                                    style: TextStyle(
                                      fontFamily: 'Metropolis',
                                      fontSize: 12,
                                      color: const Color(0xffb6b7b7),
